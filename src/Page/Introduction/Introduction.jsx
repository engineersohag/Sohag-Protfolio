...
const About = () => {
    ...
    const [text] = useTypewriter({
        words: [
            ...
            "Technical Communicator & Instructor",
        ],
        loop: 0,
        delaySpeed: 2000,
    })
        ...
        <section className="flex items-center px-4">
            ...
            >
                ...
                >
                    ...
                    <div className="relative lg:mr-50 w-48 h-48 sm:w-56 sm:h-56 md:w-64 md:h-64 lg:w-80 lg:h-80 rounded-full overflow-hidden flex-shrink-0 shadow-2xl border-4 border-primary hover:border-secondary transition-all duration-300 hover:scale-105">
                        <img
                            src='/sohag.jpg'
                            alt="Sohag Hosen"
                ...
                >
                    ...
                    <motion.p 
                        ...
                        variants={itemVariants}
                    >
                        Dynamic Full-Stack Web Developer with over 2+ years of experience specializing in the PHP & Laravel ecosystems. Adept at engineering secure, AI-driven applications by integrating OpenAI Assistant APIs, OCR data extraction, and automated subscription engines.
                    </motion.p>
                    ...
                    >
                        <motion.a
                            href='https://www.linkedin.com/in/its-engineer-sohag/'
                            target="_blank" 
                        ...
                        <motion.a
                            href='https://github.com/engineersohag'
                            target="_blank" 
                            rel="noopener noreferrer"
                            className="group relative w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 bg-base-100 border-2 border-base-content/10 
                                hover:border-info/40 rounded-xl shadow-md hover:shadow-info/20
                        ...
                        <motion.a
                                href="https://www.facebook.com/programmer.sohaghosen"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="group relative w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 
                                    bg-base-100 border-2 border-base-content/10 
                                    hover:border-info/40 rounded-xl shadow-md hover:shadow-info/20
                                    flex items-center justify-center transition-all duration-300"
                                whileHover={{ scale: 1.1, rotate: 5 }}
                                whileTap={{ scale: 0.95 }}
                                >
                                <FaFacebookF className="text-xl sm:text-2xl md:text-3xl 
                                    text-base-content group-hover:text-info transition-colors z-10" />

                                <div className="absolute inset-0 bg-info/10 opacity-0 
                                    group-hover:opacity-100 rounded-xl transition-opacity">
                                </div>
                            </motion.a>
                        <motion.a
                                href="/resume.pdf"
                                rel="noopener noreferrer"
                                download="Resume_of_Sohag_Hosen.pdf"
                                className="group relative w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 
                                    bg-base-100 border-2 border-base-content/10 
                                    hover:border-info/40 rounded-xl shadow-md hover:shadow-info/20
                                    flex items-center justify-center transition-all duration-300"
                                ...
                                whileTap={{ scale: 0.95 }}
                                >
                                <FaDownload className="text-xl sm:text-2xl md:text-3xl 
                                    text-base-content group-hover:text-info transition-colors z-10" />
