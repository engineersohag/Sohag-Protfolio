    ...
    const achievements = [
        {
            ...
            description: "NSDA (National Skill Development Authority) Government Certified Level-3 in Web Design & Development",
            icon: FaCode
        },
        {
            id: 2,
            title: "Best Project Showcase Award",
            description: "At DUET Robotics Club’s prestigious DUET Techfest, My project proudly First Runner-Up with the “Life Line” project.",
            icon: FaMedal
        },
        
        {
            id: 3,
            title: "Best Speacker Award",
            description: "Honored to receive the Best Speaker Award at the Inter-Department Debate Competition, recognizing excellence in debate and articulation.",
            icon: FaTrophy
        }
    ];
