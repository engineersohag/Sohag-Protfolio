...
const Services = () => {
    ...
    const services = [
        ...
        },
        {
            ...
            description: "Building scalable, secure, and high-performance web applications tailored to business needs",
            features: [
                "Custom web application development",
                "Responsive and cross-browser compatibility",
                "Accessible and standards-compliant development"
            ]
        },
        {
            id: 6,
            icon: FaBug,
            title: "Bug Fixing",
            description: "Identifying, debugging, and resolving issues to ensure smooth and reliable application performance",
            features: [
                "Frontend and backend bug fixing",
                "Logic, performance, and security issue resolution",
                "Cross-browser and device compatibility fixes"
            ]
        }
    ];
