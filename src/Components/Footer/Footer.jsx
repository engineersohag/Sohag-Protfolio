...
const Footer = () => {
    const socialLinks = [
        { icon: <FaGithub />, href: "https://github.com/engineersohag" },
        { icon: <CiLinkedin />, href: "https://www.linkedin.com/in/its-engineer-sohag/" },
        // { icon: <FaInstagram />, href: "https://www.instagram.com/arfan_ratul_46/" },
        { icon: <CiFacebook />, href: "https://www.facebook.com/programmer.sohaghosen" }
    ];
    ...
    return (
        ...
        >
            ...
            <div className="relative container mx-auto">
                ...
                {/* Main Content */}
                <div className="grid px-8 grid-cols-1 md:grid-cols-3 gap-6 items-center text-center md:text-left">
                    
                    {/* Name & Title */}
                    <div className="space-y-2">
                        <h3 className="text-lg md:text-xl font-bold text-primary">Sohag Hosen</h3>
                    </div>
                    ...
                    <div className="space-y-2 md:text-right">
                        ...
                        <a href="https://mail.google.com/mail/?view=cm&fs=1&to=engineer.sohag.cse@gmail.com" className="inline-flex items-center gap-2 text-sm text-primary hover:opacity-80">
                ...
                {/* Copyright */}
                <div className="px-5 mt-8 pt-6 border-t border-base-content/5">
                    <div className="flex flex-col md:flex-row justify-between items-center gap-3 text-center md:text-left">
                        <p className="text-xs text-base-content/50">
                            © {new Date().getFullYear()} Sohag Hosen. All rights reserved.
                        </p>
